...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  let valor = array.findIndex(e=>e===elemento)
...
function mesesDelAño(array) {
  ...
  if(auxArray.length<3) return "No se encontraron los meses pedidos";
  return auxArray;
}
...
function mayorACien(array) {
  ...
  // Tu código:
  let auxArray = array.filter(e=>e>100)
  return auxArray;
}
...
function breakStatement(numero) {
  ...
  if(cont<10) return "Se interrumpió la ejecución"
  return array;
}
